...
*Note:* the :doc:`main pings <main-ping>` are kept locally even after successful submission to enable SelfSupport features. They will be deleted after their retention period of 180 days.
